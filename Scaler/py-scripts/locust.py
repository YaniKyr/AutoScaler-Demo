...
n_timesteps = 800 # Number of time steps in the dataset
timestep_min = 1  # Minimum timestep in seconds
timestep_max = 10  # Maximum timestep in seconds
start_end_period_seconds = 5 * 60  # 10 minutes in seconds
start_end_user_range = (5,10)  # User count during start/end period
