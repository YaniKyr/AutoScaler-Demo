...
def main():
    ...
    actors = [
        md.build_linear_actor_critic(model.state_size, model.action_size),
        md.build_shallow_mlp_actor_critic(model.state_size, model.action_size),
        md.build_deep_mlp_actor_critic(model.state_size, model.action_size)
    ]
